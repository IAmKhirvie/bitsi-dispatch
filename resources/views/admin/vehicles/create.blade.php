...
@section('title', 'Create Bus - BITSI Dispatch')
    ...
    <div class="flex h-full flex-1 flex-col gap-4 p-4">
        <div class="mx-auto w-full max-w-2xl">
            <div class="rounded-xl border bg-card text-card-foreground shadow">
                <div class="p-6">
                    <h3 class="font-semibold leading-none tracking-tight">Create Bus</h3>
                    <p class="text-sm text-muted-foreground">Add a new bus to the fleet.</p>
                </div>
                <div class="p-6 pt-0">
