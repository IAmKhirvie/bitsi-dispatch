...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/admin/vehicles/${props.vehicle.id}/edit` },
];

const form = useForm({
    bus_number: props.vehicle.bus_number,
    ...
    last_pms_date: props.vehicle.last_pms_date || '',
});
...
<template>
    <Head :title="`Edit Vehicle ${vehicle.bus_number}`" />
            ...
            <div class="mx-auto w-full max-w-2xl">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update vehicle {{ vehicle.brand }} {{ vehicle.bus_number }}.</CardDescription>
                    </CardHeader>
                    <CardContent>
