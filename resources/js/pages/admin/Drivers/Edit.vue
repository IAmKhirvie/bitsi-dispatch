...
import { type BreadcrumbItem, type Driver, type DriverStatus } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/admin/drivers/${props.driver.id}/edit` },
];
...
const form = useForm({
    ...
    status: props.driver.status || 'available' as DriverStatus,
});
            ...
            <div class="mx-auto w-full max-w-2xl">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update information for {{ driver.name }}.</CardDescription>
                    </CardHeader>
                    <CardContent>
